...
#     """
#     db_directory_path = f'''"bird/bird_train/train_databases"/{db_id}'''
...
#     print('###',args.db_root_directory,args.db_id,args.n_gram ,args.threshold ,args.verbose , args.use_value_description )
#     if args.db_id == 'all':
#         with multiprocessing.Pool(NUM_WORKERS) as pool:
#             print("@@@@", args.db_root_directory)
#             for db_id in os.listdir("bird/bird_train/train_databases"):
