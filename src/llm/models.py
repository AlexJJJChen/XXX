...
def get_llm_chain(engine: str, temperature: float = 0, base_uri: str = None) -> Any:
    ...
    if base_uri and "openai_api_base" in params:
        ...
        print('### base_uri:', params["openai_api_base"])
...
def call_other_llm(prompt: Any):

    device = "cuda" # or "cpu"
    model_path = "/project/chenjian/nl2sql/CHESS-main/granite-34b-code-base"
    #save_directory = "/project/chenjian/nl2sql/CHESS-main/"  # Specify your custom path here
