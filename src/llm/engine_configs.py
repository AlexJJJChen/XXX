...
ENGINE_CONFIGS: Dict[str, Dict[str, Any]] = {
    ...
    "gpt-4o-2024-08-06": {
        "constructor": ChatOpenAI,
        "params": {"model":  "gpt-4o-2024-08-06", "temperature": 0}
    },
        "gpt-4o": {
    ...
    "gpt-4o-all": {
        "constructor": ChatOpenAI,
        "params": {"model":  "gpt-4o-all", "temperature": 0}
    },
    "o1-preview-2024-09-12":{
        "constructor": ChatOpenAI,
        "params": {"model":  "o1-preview-2024-09-12", "temperature": 0}
    },
    "o1-mini-2024-09-12":{
        "constructor": ChatOpenAI,
        "params": {"model":  "o1-preview-2024-09-12", "temperature": 0}
    ...
    "gpt-4-0125-preview": {
        "constructor": ChatOpenAI,
        "params": {"model": "o1-mini-2024-09-12", "temperature": 0}
    },
    "gpt-4-turbo": {
        "constructor": ChatOpenAI,
    ...
    "gpt-4-turbo-2024-04-09": {
        "constructor": ChatOpenAI,
        "params": {"model": "gpt-4-turbo-2024-04-09", "temperature": 0}
    },
